  ...
  return (
    ...
    >
      <div className="flex items-center justify-between border-b border-gray-100 px-4 py-3">
        <h2 className="text-sm font-semibold text-gray-900">상세</h2>
      ...
      <dl className="grid grid-cols-[100px_1fr] gap-x-4 gap-y-3 px-4 py-4 text-sm">
        ...
        <dt className="text-gray-500">채널</dt>
        ...
        <dt className="text-gray-500">순서</dt>
        ...
        <dt className="text-gray-500">관리자 전용</dt>
        <dd>
          <span
            className={`inline-flex rounded-full px-2 py-0.5 text-xs font-medium ${
      ...
      <div className="border-t border-gray-100 px-4 py-3">
        ...
        <p className="mb-3 text-xs text-gray-500">
          게시판 연동 시 리스트로, 게시글 연동 시 해당 글로 이동합니다. 우선순위: 게시판 → 게시글 → 경로.
        </p>

        <div className="space-y-3">
          <div>
            <div className="mb-1 text-xs font-medium text-gray-600">게시판</div>
            {linkedBoard ? (
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  disabled={linking}
                >
                  <Unlink className="h-3 w-3" /> 연동 해제
                </button>
              </div>
            ) : (
              <div className="flex gap-2">
          ...
          <div>
            <div className="mb-1 text-xs font-medium text-gray-600">게시글</div>
            {linkedTopic ? (
              <div className="flex items-center gap-2">
